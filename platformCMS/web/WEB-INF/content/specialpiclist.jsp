	...
	<div class="container">
		...
		<div id="content">
            ...
            <div id="maincontent">
                 <div id="listleft">
                        <ul>
							<li><a href="${ctx}/specialpiclist.action?showCategory.id=57&isNewsVote=all"><span>ALL_查看全部</span></a></li>
							<li><span>&nbsp;</span></li>
						    <s:iterator value="category.child" status="stat">
								<li><a href="${ctx}/specialpiclist.action?showCategory.id=${id }"><span><s:property value="name"/>_<s:property value="nameEn"/></span></a></li>
							</s:iterator>
							<li><span>&nbsp;</span></li>
							<li><a href="${ctx}/specialpiclist.action?showCategory.id=57&isNewsVote=recommend"><span>UP_特别推荐</span></a></li>
							<li><span>&nbsp;</span></li>
							<li><a href="${ctx}/specialpiclist.action?showCategory.id=57&isNewsVote=news"><span>NEWS_最新发布</span></a></li>
							<li><span>&nbsp;</span></li>
							<li><a href="${ctx}/specialpiclist.action?showCategory.id=57&isNewsVote=vote"><span>VOTE_投票排行</span></a></li>
							<li><span>&nbsp;</span></li>
                 ...
                 <div id="listcenter">
                         <div class="tabshow_title">
                            <h3>专题 _${showCategory.name}</h3>
                            <ul>
                                <li><span><a href="${ctx}/speciallist.action?showCategory.id=${showCategory.id}" class="tablink" >列表显示</a></span></li>
                                <li><span><a href="${ctx}/specialpiclist.action?showCategory.id=${showCategory.id}" class="tablink" >图标显示</a></span></li>
                            </ul>
                        </div>
                        <div id="case_show">
                                ...
                                <div id="case_show_content">
                                  <s:iterator value="page.result">
                                     <div id="case_show_content_detalied">
                                    		 <a class="coverBg" href="${ctx}/specialcontent.action?article.id=${id}">READ MORE<p>(查看全部)</p></a>
                                           ...
                                           <p>&nbsp;</p>
                                           <h3><a href="${ctx}/specialcontent.action?article.id=${id}" title="${title }"><ouun:substring length="8" value="${title }"/></a></h3>
                    ...
                    <div style="padding-left:10px;padding-top:40px;width:600px">
						...
						<s:if test="page.hasPre">
							<a href="specialpiclist.action?page.pageNo=${page.prePage}&page.orderBy=${page.orderBy}&page.order=${page.order}&showCategory.id=${showCategory.id}&isNewsVote=${isNewsVote}">上一页</a>
						</s:if>
						<ouun:pageNum totalPages="${page.totalPages}" pageNo="${page.pageNo}" url="specialpiclist.action?page.orderBy=${page.orderBy}&page.order=${page.order}&showCategory.id=${showCategory.id}&isNewsVote=${isNewsVote}&page.pageNo=" />
						<s:if test="page.hasNext">
							<a href="specialpiclist.action?page.pageNo=${page.nextPage}&page.orderBy=${page.orderBy}&page.order=${page.order}&showCategory.id=${showCategory.id}&isNewsVote=${isNewsVote}">下一页</a>
						</s:if>
					</div>
