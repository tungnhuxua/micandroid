...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<title>秀场-${article.category.name }-${article.title }</title>
	...
	<div class="container">
		...
		<div id="content">
			...
			<div id="postion">
				<p>
					<span>您的位置:首页&gt;秀场&gt;${article.category.name }</span>
				</p>
			</div>
			...
			<div id="contentLeft">
				...
				<div id="projectscontent">
					<dl id="proleft">
						...
						<s:iterator value="TagCorrelationArticle">
							<dd><span><a href="${ctx}/showcontent.action?article.id=${id}">${title}</a></span></dd>
						</s:iterator>
					</dl>
				...
				<div id="articlelist">
					...
					<div>
					<dl>
						<dt>${member.name } , <s:date name="createDate" format="yyyy年MM月dd日" />,<s:date name="createDate" format="HH.mm.ss" /> <security:authorize ifAnyGranted="A_VIEW_XC"><!--  <span onclick="editComment('${id}');" style="cursor: pointer;">编辑</span> --><span onclick="delComment('${id }',this);" style="cursor: pointer;">删除</span></security:authorize></dt>
						<dd>${content}</dd>
					</dl>
					</div>
					</div>
					...
					<!-- 分页验证权限 -->
					<security:authorize ifAnyGranted="A_VIEW_XC"><input type="hidden" id="authority" value="A_VIEW" /></security:authorize>
				...
				<div id="contentFoot">
					<div id="contentFoot_nav">
						<h3><span>导航&gt;</span><span>设计圈首页&gt;</span><span class="selectNav">秀场</span></h3>
						<ul>
					...
					<div id="contentFoot_seach">
						...
						<div>
							<input type="radio" name="seachto" checked="checked" /><span>common.com</span>
