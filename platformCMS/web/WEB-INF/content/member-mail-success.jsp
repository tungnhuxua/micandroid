		...
		<div id="content">
			...
			<s:if test="isMidMailcode">
                ...
                <div class="bqmainbh" align="left">
					...
					<div class="gongxi" align="left">恭喜你！邮件激活成功,<br /><br />请您重新登录，完善您的个性资料。
					</div>
	            </div>
			</s:if><s:else>
				<div style="width:830px; margin-top:40px;float:right;" >
                <div class="bqmainbh" align="left">
					...
					<div class="gongxi" align="left">对不起！邮件激活失败,<br /><br />您的邮件激活地址不合法。
					</div>
	            </div>
			</s:else>
        <div class="clean"></div>
