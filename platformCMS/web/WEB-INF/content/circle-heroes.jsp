            ...
            <div id="maincontent">
                 ...
                 <div id="listcenter">
                        ...
                        <div id="case_show">
	                         <div id="case_heroes">
	                          <h3>_色女郎_Se Girl</h3>
	                          	<s:iterator value="seGirPage.result">
	                         ...
	                         <div id="case_heroes">
	                          <h3>_视觉_Visual</h3>
	                          <s:iterator value="visualPage.result">
	                                <div id="case_show_content">
	                                   <div id="case_show_content_detalied">
	                                       <a class="coverBg100" href="${ctx}/blog/blog-home.action?tomember.id=${id}">${name}<p>READ MORE</p></a>
	                                           <a class="borderima" href="${ctx}/blog/blog-home.action?tomember.id=${id}">
                              ...
                              <div id="case_heroes">
	                          <h3>_艺术_Art</h3>
	                          	<s:iterator value="artPage.result">
	                                <div id="case_show_content">
	                                   <div id="case_show_content_detalied">
	                                       <a class="coverBg100" href="${ctx}/blog/blog-home.action?tomember.id=${id}">${name}<p>READ MORE</p></a>
	                                           <a class="borderima" href="${ctx}/blog/blog-home.action?tomember.id=${id}">
	                          ...
	                          <s:iterator value="mediaPage.result">
	                                <div id="case_show_content">
	                                   <div id="case_show_content_detalied">
	                                       <a class="coverBg100" href="${ctx}/blog/blog-home.action?tomember.id=${id}">${name}<p>READ MORE</p></a>
	                                           <a class="borderima" href="${ctx}/blog/blog-home.action?tomember.id=${id}">
	                          ...
	                          <div id="case_heroes">
	                          <h3>_摄影_Photography</h3>
	                               
	                               
	                             <s:iterator value="photographyPage.result">
	                                <div id="case_show_content">
	                                   <div id="case_show_content_detalied">
	                                       <a class="coverBg100" href="${ctx}/blog/blog-home.action?tomember.id=${id}">${name}<p>READ MORE</p></a>
	                                           <a class="borderima" href="${ctx}/blog/blog-home.action?tomember.id=${id}">
	                          ...
	                          <div id="case_heroes">
	                          <h3>_策略文案_Plan</h3>
	                                 <s:iterator value="planPage.result">
	                                <div id="case_show_content">
	                                   <div id="case_show_content_detalied">
	                                       <a class="coverBg100" href="${ctx}/blog/blog-home.action?tomember.id=${id}">${name}<p>READ MORE</p></a>
	                                           <a class="borderima" href="${ctx}/blog/blog-home.action?tomember.id=${id}">
	                          ...
	                          <div id="case_heroes">
	                          <h3>_空间_Speal</h3>
	                                 <s:iterator value="spealPage.result">
	                                <div id="case_show_content">
	                                   <div id="case_show_content_detalied">
	                                       <a class="coverBg100" href="${ctx}/blog/blog-home.action?tomember.id=${id}">${name}<p>READ MORE</p></a>
	                                           <a class="borderima" href="${ctx}/blog/blog-home.action?tomember.id=${id}">
