...
<div id="addGroup" style="display:none">
  ...
  <form method="post" action="${ctx }/blog/addShowCategory.action" id="addGroupForm">
	  <ul style="">
	    <li style="float: left;">分类：<input type="text" class="qq" name="showCategory.name"/></li>
	...
	<div class="content">
		...
		<div class="main">
			<div class="mainbh">
				...
				<div class="zhuti">
				<div class="gerenshoucangbt">CASE Show_秀场_每发布一篇作品即可获得0喔元，如被秀场频道发布更可获得0喔元奖励！</div>
				<div class="faburizhixx"><a href="article!input.action?cateId=56">_发布新作品</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!-- <a href="">_管理设置</a>&nbsp;&nbsp;&nbsp;&nbsp;<input name="lb" type="radio" value="" />列表显示&nbsp;&nbsp;<input name="lb" type="radio" value="" />图标显示 --></div>
				 <div class="zdyhaoyou">
				 	<ul>
						<s:iterator value="showCate">
				 			<li><a href="${ctx }/blog/article-show.action?cateId=${cateId}&logId=<s:property value="id"/>">_<s:property value="name"/></a></li>	
				 		</s:iterator>
						<li><a href="${ctx }/blog/article-show.action?cateId=${cateId}">_显示全部</a></li>
						<li><a style="text-decoration: underline; color: rgb(131, 195, 37);" href="javascript:showAddShow();">_添加秀场分类</a></li>
					</ul>
				 </div>
				...
				<div class="qyyear">
					<div class="qyzhongjianyeshu">
						...
						<s:if test="page.hasPre">
							<a href="${ctx }/blog/article-show.action?page.pageNo=${page.prePage}&cateId=${cateId}">上一页</a>
						</s:if>
						<ouun:pageNum totalPages="${page.totalPages}" pageNo="${page.pageNo}" url="${ctx }/blog/article-show.action?cateId=${cateId}&page.pageNo=" />
						<s:if test="page.hasNext">
							<a href="${ctx }/blog/article-show.action?page.pageNo=${page.nextPage}&cateId=${cateId}">下一页</a>
						</s:if> 
						</ul>
					</div>
