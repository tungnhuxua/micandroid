...
var cms_delete = {action:"message!receiveDelete.action",msg:"您确定删除吗？"};
var cms_delete_batch = {action:"message!deleteReceiveBatch.action",msg:"您确定删除吗？"};
	...
	<div class="content">
		...
		<div class="main">
			<div class="mainbh">
				...
				<div class="zdyhaoyou">_系统信息_(共${page.totalCount}条信息)</div>
				<div class="gexingshezhi">
				  <table width="600" cellspacing="5" border="0" class="miaobian">
                    <tbody>
                    <s:iterator value="page.result">
                    <tr <s:if test='isread != "1"'> style='font-weight:bold;'</s:if> >
                      ...
                      <td width="56" valign="top">${fromMember.name }</td>
                      <td width="171" valign="top"><a href="${ctx }/blog/message!receivedetail.action?id=${id}">${title }</a></td>
                      <td width="166" valign="top"><s:date name="createDate" format="yyyy-MM-dd hh:mm:ss" /></td>
                      <td width="88" valign="top"><a href="javascript:_operate(cms_delete,'${id }');">删除</a> | <a href="${ctx }/blog/message!input.action?reid=${id}">回复</a></td>
                    </tr>
                    <tr>
                      <td colspan="5"> </td>
                    </tr>
				...
				<div style="padding-top: 30px;" class="qyzhongjianyeshu">
						...
						<s:if test="page.hasPre">
							<a href="${ctx }/blog/message!receive.action?page.pageNo=${page.prePage}">上一页</a>
						</s:if>
						<ouun:pageNum totalPages="${page.totalPages}" pageNo="${page.pageNo}" url="${ctx }/blog/message!receive.action?page.pageNo=" />
						<s:if test="page.hasNext">
							<a href="${ctx }/blog/message!receive.action?page.pageNo=${page.nextPage}">下一页</a>
						</s:if>
						</ul>
					</div>
