				...
				<div class="qyyear">
					<div class="qyzhongjianyeshu">
						...
						<s:if test="page.hasPre">
							<a href="${ctx }/blog/blog-date-log.action?page.pageNo=${page.prePage}&tomember.id=${tomember.id}&date=${date}">上一页</a>
						</s:if>
						<ouun:pageNum totalPages="${page.totalPages}" pageNo="${page.pageNo}" url="${ctx }/blog/blog-date-log.action?tomember.id=${tomember.id}&date=${date}&page.pageNo=" />
						<s:if test="page.hasNext">
							<a href="${ctx }/blog/blog-date-log.action?page.pageNo=${page.nextPage}&tomember.id=${tomember.id}&date=${date}">下一页</a>
						</s:if>
						</ul>
					</div>
