	...
	<div class="content">
		...
		<div class="main">
			<div class="mainbh">
				...
				<div class="zhuti">
				<div class="yaoqitibt">Mailbox_发信箱_(共${count }条信息)</div>
				<div class="grdangan">
					<ul>
						<%@include file="/common/blog-message-nav.jsp" %>
					</ul>
				</div>
				<div class="xjbiaoti">${sendMessage.title }</div>	
				<div class="zjrziliao">
					<ul>
						<li><a href="">收件人_${sendMessage.toMember.loginName }</a></li>
						<li><a href="">时间_<s:date name="sendMessage.createDate" format="yyyy-MM-dd hh:mm:ss" /></a></li>
						<li><a href="">发件人_${sendMessage.fromMember.name }</a></li>
					</ul>
				...
				<div class="sjtuangdui"></div>	
				<div class="sjtuangdui">   <a href="javascript:history.go(-1);">_返回Back</a>    <a href="${ctx }/blog/message!sendDelete.action?id=${sendMessage.id}">_删除Remove</a></div>	
		</div>
		</div>
		<div class="footer">
