			...
			<div class="bqmainbh">
				...
				<div class="shoucanweizhi">
					...
					<ul class="scxuangxiang">
						<li>_<a href="${ctx }/blog/blog-log-list.action?tomember.id=${tomember.id}">列表显示</a></li>
						<li>_<a href="${ctx }/blog/blog-log.action?tomember.id=${tomember.id}">图标显示</a></li>
					</ul>
				</div>
				...
				<div class="qyyear">
					<div class="qyzhongjianyeshu">
						...
						<s:if test="page.hasPre">
							<a href="${ctx }/blog/blog-log-list.action?page.pageNo=${page.prePage}&tomember.id=${tomember.id}">上一页</a>
						</s:if>
						<ouun:pageNum totalPages="${page.totalPages}" pageNo="${page.pageNo}" url="${ctx }/blog/blog-log-list.action?tomember.id=${tomember.id}&page.pageNo=" />
						<s:if test="page.hasNext">
							<a href="${ctx }/blog/blog-log-list.action?page.pageNo=${page.nextPage}&tomember.id=${tomember.id}">下一页</a>
						</s:if>
						</ul>
					</div>
