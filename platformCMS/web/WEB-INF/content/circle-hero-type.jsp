            ...
            <div id="maincontent">
                 ...
                 <div id="listcenter">
                         <div class="tabshow_title">
                            <h3>江湖_${type.name}_${type.nameEn }</h3>
                            <ul>
                                <li><span></span></li>
                                <li><span></span></li>
                            </ul>
                    ...
                    <div style="padding-left:10px;padding-top:40px;width:760px">
						...
						<s:if test="page.hasPre">
							<a href="${ctx }/circle-hero-type?type.id=${type.id}&page.pageNo=${page.prePage}">上一页</a>
						</s:if>
						<ouun:pageNum totalPages="${page.totalPages}" pageNo="${page.pageNo}" url="circle-hero-type?type.id=${type.id}&page.pageNo=" />
						<s:if test="page.hasNext">
							<a href="${ctx }/circle-hero-type?type.id=${type.id}&page.pageNo=${page.nextPage}">下一页</a>
						</s:if>
					</div>
                     	<div id="contentFoot_nav_1">
                                <h3><span>导航&gt;</span><span>设计圈首页&gt;</span><span class="selectNav">江湖</span></h3>
                                <ul>
                                    <li><a href="#"><span>_vip</span></a></li>
