	...
	<div class="container">
		...
		<div id="content">
            ...
            <div id="maincontent">
                 <div id="listleft">
                        <ul>
							<li><a href="${ctx}/personpiclist.action?showCategory.id=55&isNewsVote=all"><span>ALL_查看全部</span></a></li>
							<li><span>&nbsp;</span></li>
						    <s:iterator value="category.child" status="stat">
								<li><a href="${ctx}/personpiclist.action?showCategory.id=${id }"><span><s:property value="name"/>_<s:property value="nameEn"/></span></a></li>
							</s:iterator>
							<li><span>&nbsp;</span></li>
							<li><a href="${ctx}/personpiclist.action?showCategory.id=55&isNewsVote=recommend"><span>UP_特别推荐</span></a></li>
							<li><span>&nbsp;</span></li>
							<li><a href="${ctx}/personpiclist.action?showCategory.id=55&isNewsVote=news"><span>NEWS_最新发布</span></a></li>
							<li><span>&nbsp;</span></li>
							<li><a href="${ctx}/personpiclist.action?showCategory.id=55&isNewsVote=vote"><span>VOTE_投票排行</span></a></li>
							<li><span>&nbsp;</span></li>
                 ...
                 <div id="listcenter">
                                ...
                                <div id="case_show_content">
                                  <s:iterator value="page.result">
                                     <div id="case_show_content_detalied">
                                     	<a class="coverBg" href="${ctx}/personcontent.action?article.id=${id}">READ MORE<p>(查看全部)</p></a>
                                           <s:if test="imageUri!=null && imageUri != ''"><img width="140" height="140" src="${ctx}${imageUri}" alt="" />
											</s:if><s:else>
											<a class="coverBg" href="${ctx}/personcontent?article.id=${id}">READ MORE<p>(查看全部)</p></a>
                                              <img width="140" height="140" src="images/hot_essay.jpg" />
                                            </s:else>
                                           <p>&nbsp;</p>
                                           <h3><a href="${ctx}/personcontent.action?article.id=${id}" title="${title }"><ouun:substring length="8" value="${title }"/></a></h3>
                    ...
                    <div style="padding-left:10px;padding-top:40px;width:600px">
						...
						<s:if test="page.hasPre">
							<a href="personpiclist.action?page.pageNo=${page.prePage}&page.orderBy=${page.orderBy}&page.order=${page.order}&showCategory.id=${showCategory.id}&isNewsVote=${isNewsVote}">上一页</a>
						</s:if>
						<ouun:pageNum totalPages="${page.totalPages}" pageNo="${page.pageNo}" url="personpiclist.action?page.orderBy=${page.orderBy}&page.order=${page.order}&showCategory.id=${showCategory.id}&isNewsVote=${isNewsVote}&page.pageNo=" />
						<s:if test="page.hasNext">
							<a href="personpiclist.action?page.pageNo=${page.nextPage}&page.orderBy=${page.orderBy}&page.order=${page.order}&showCategory.id=${showCategory.id}&isNewsVote=${isNewsVote}">下一页</a>
						</s:if>
					</div>
