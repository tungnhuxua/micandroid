...
<title>人物-${article.category.name }-${article.title }</title>
...
<div id="content">
<div id="topBanner"><s:if test="adsArray.length>0">
...
<div id="postion">
<p><span>您的位置:首页&gt;人物&gt;${article.category.name }</span></p>
</div>

<div id="contentLeft">
<div id="totop"><a href="#top" rel=""> <img
	src="images/toTop.gif" alt="返回顶部" /> </a></div>
<div id="news"><s:if test="imageUri!=null && imageUri != ''">
	<img src="${ctx}${imageUri}" alt="" />
</s:if> <s:else>
	<div id="newspiaoshu">
		<ul>
			<li><span>票数</span></li>
...
<p>来源_${article.source } | 作者_${article.member.name } | 发布时间_<s:date
	name="article.createDate" format="yyyy-MM-dd" /></p>
...
<p>TAG:<ouun:articletag href="#" value="${article.tag}" /></p>
</div>
<div id="newsmaincontent" rel="newscontent">${article.content }</div>
<div id="twoimage"><img id="ding" src="images/ding.gif"
	style="cursor: pointer;" onclick="woding(${article.id});" /> <img
	src="images/tanks.gif" alt="" class="thanks" style="display: none;" />
</div>
<div id="voteinfo">
<dl>
	<dt><span id="vcount">${article.voteCount}</span>已投票数</dt>
	<s:if test="preArticle!=null">
		<dd><a href="${ctx}/personcontent.action?article.id=${preArticle.id}">上一篇_
		${preArticle.title }</a></dd>
	</s:if>
	<s:if test="nextArticle!=null">
		<dd><a href="${ctx}/personcontent.action?article.id=${nextArticle.id}">下一篇_
		${nextArticle.title}</a></dd>
	</s:if>
</dl>
</div>
...
<dl id="proleft">
	...
	<s:iterator value="TagCorrelationArticle">
		<dd><span><a href="${ctx}/personcontent.action?article.id=${id}">${title}</a></span></dd>
	</s:iterator>
</dl>
...
<div>
<dl>
	<dt>${member.name } , <s:date name="createDate" format="yyyy年MM月dd日" />,<s:date name="createDate" format="HH.mm.ss" /> <security:authorize ifAnyGranted="A_VIEW_RW"><!--  <span onclick="editComment('${id}');" style="cursor: pointer;">编辑</span>--> <span onclick="delComment('${id }',this);" style="cursor: pointer;">删除</span></security:authorize></dt>
	<dd>${content}</dd>
</dl>
</div>
</div>
...
<!-- 分页验证权限 -->
<security:authorize ifAnyGranted="A_VIEW_RW"><input type="hidden" id="authority" value="A_VIEW" /></security:authorize>
<div id="pagecount">
<ul>
...
<h3><span>导航&gt;</span><span>设计圈首页&gt;</span><span
	class="selectNav">人物</span></h3>
<ul>
...
<div><input type="radio" name="seachto" checked="checked" /><span>common.com</span>
<input type="radio" name="seachto" /><span>google</span></div>
<div class="firstP"><span>你的足迹 登入注册你的免费账号</span></div>
<div id="contentFoot_tags"><a href="#"><span>发现</span></a> <a
	href="#"><span>资讯</span></a> <a href="#"><span>分享</span></a> <a
	href="#"><span>下载</span></a> <a href="#"><span>blog</span></a> <a
	href="#"><span>本周</span></a> <a href="#"><span>本月</span></a> <a
	href="#"><span>热门标签</span></a> <a href="#"><span>会员</span></a> <a
	href="#"><span>搜索</span></a> <a href="#"><span>发现</span></a> <a
	href="#"><span>设计圈</span></a> <a href="#"><span>ooowo小帮手</span></a> <a
	href="#"><span>社区指南</span></a> <a href="#"><span>说明讨论区</span></a> <a
	href="#"><span>常见问题</span></a> <a href="#"><span>帮助</span></a></div>
</div>
</div>
<div id="bannerThree"><s:if test="adsArray.length>2">
...
<div class="clean"></div>
<div id="longdetails">
<div class="longdetails_left"><img src="images/DetailsImage.gif"
	alt="" /></div>
...
<div>
<p>声明网站所转载的文章，书籍等内容纯属作者个人观点，并不代表本站观点。 欢迎转载，敬请书名转载设计圈网 ooowo.com</p>
</div>
</div>
</div>
...
<div id="rightContent">
<div id="rightContent_top"><s:if test="adsArray.length>3">
...
<a href="#"><span>创意</span></a> <a href="#"><span>coool</span></a> <a
	href="#"><span>家居</span></a> <a href="#"><span>有趣</span></a> <a
	href="#"><span>风格</span></a> <a href="#"><span>酷玩</span></a> <a
	href="#"><span>科技</span></a> <a href="#"><span>文化</span></a> <a
	href="#"><span>手机</span></a> <a href="#"><span>头枕</span></a> <a
	href="#"><span>性感</span></a> <a href="#"><span>视频</span></a> <a
	href="#"><span>BEDU</span></a> <a href="#"><span>遥控狙击枪</span></a> <a
	href="#"><span>科技数码</span></a> <a href="#"><span>电击枪</span></a> <a
	href="#"><span>有趣的家具</span></a> <a href="#"><span>鼻钉</span></a> <a
	href="#"><span>鼻环</span></a> <a href="#"><span>超酷饰品</span></a> <a
	href="#"><span>神奇茶几</span></a> <a href="#"><span>机器猫的竹蜻蜓</span></a> <a
	href="#"><span>数字抽屉</span></a> <a href="#"><span>温暖</span></a> <a
	href="#"><span>有趣橱柜</span></a></div>

<div class="advtype2"><s:if test="adsArray.length>4">
...
</s:else> <s:if test="adsArray.length>5">
	...
	<img src="images/hotcommodity1.gif" alt="" />
</s:else> <s:if test="adsArray.length>6">
...
<div class="advtype3"><s:if test="adsArray.length>7">
...
<div class="clean"></div>
<div id="bannerFour"><s:if test="adsArray.length>8">
