	...
	<div class="container">
		...
		<div id="content">
						...
						<div id="highlight">
							<div id="featured">
								...
								<div class="image" id="image_xixi-<s:property value='#sta.index+1'/>">
									<a title="${title }" <s:if test="uri!=null && uri!=''">href="${uri}"</s:if><s:else>href="${ctx}/personcontent.action?article.id=${id}"</s:else>  target="_blank">
                ...
                <div class="userlist">
                     <div>
                        <ul>
                           ...
                           <li>
                            <a class="coverBg110" href="${ctx}/personcontent.action?article.id=${id}"><p>(查看全部)</p></a>
			...
			<div>
                <div class="details">
					<div class="details_all">
						<h4><a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[0].id"/>"><strong><s:property value="subCategory[0].nameEn"/>_<s:property value="subCategory[0].name"/></strong></a></h4>
						<a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[0].id"/>"><span>more</span></a>
						<ul class="listOne">
                            <s:iterator value="articles.get(0)">
                            	<li><a href="${ctx}/personcontent.action?article.id=${id}" title="${title }"><ouun:substring length="20" value="${title }"/></a></li>
                            </s:iterator>
                            <li></li>
                            <li><a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[0].id"/>">_more</a></li>
						</ul>
				...
				<div class="details">
					<div class="details_all">
						<h4><a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[1].id"/>"><strong><s:property value="subCategory[1].nameEn"/>_<s:property value="subCategory[1].name"/></strong></a></h4>
						<a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[1].id"/>"><span>more</span></a>
						<ul class="listOne">
                            <s:iterator value="articles.get(1)">
                            	<li><a href="${ctx}/personcontent.action?article.id=${id}" title="${title }"><ouun:substring length="20" value="${title }"/></a></li>
                            </s:iterator>
                            <li></li>
                            <li><a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[1].id"/>">_more</a></li>
						</ul>
            ...
            <div>
				<div class="details">
                        <div class="details_all">
                            <h4><a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[2].id"/>"><strong><s:property value="subCategory[2].nameEn"/>_<s:property value="subCategory[2].name"/></strong></a></h4>
                            <a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[2].id"/>"><span>more</span></a>
                            <ul class="listOne">
                            <s:iterator value="articles.get(2)">
                            	<li><a href="${ctx}/personcontent.action?article.id=${id}" title="${title }"><ouun:substring length="20" value="${title }"/></a></li>
                            </s:iterator>
                            <li></li>
                            <li><a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[2].id"/>">_more</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="details">
                        <div class="details_all">
                            <h4><a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[3].id"/>"><strong><s:property value="subCategory[3].nameEn"/>_<s:property value="subCategory[3].name"/></strong></a></h4>
                            <a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[3].id"/>"><span>more</span></a>
                            <ul class="listOne">
                            <s:iterator value="articles.get(3)">
                            	<li><a href="${ctx}/personcontent.action?article.id=${id}" title="${title }"><ouun:substring length="20" value="${title }"/></a></li>
                            </s:iterator>
                            <li></li>
                            <li><a href="${ctx}/personlist.action?showCategory.id=<s:property value="subCategory[3].id"/>">_more</a></li>
                            </ul>
                        </div>
                    </div>
              </div>  
