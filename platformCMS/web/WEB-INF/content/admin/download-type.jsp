...
<div class="body-box">
<div class="rhead">
	<div class="rpos">当前位置： 下载分类管理 - <s:if test="entity.name!=null">${entity.name} - </s:if>列表</div>
	<div class="clear"></div>
</div>
<script language="javascript">
var cms_edit = {action:"download-type!input"};
var cms_delete = {action:"download-type!delete?entity.parent.id=${entity.id}",msg:"您确定删除吗？"};
...
<div class="pn-lbopt">
	<input value="删除" onclick="if(confirm('您确定删除吗？')){this.form.action='download-type!deleteBatch?entity.parent.id=${entity.id}';return true;}else{return false;}" type="submit">
&nbsp; <input value="保存排列顺序" onclick="this.form.action='download-type!sort?entity.parent.id=${entity.id}';this.form.onsubmit=null;" type="submit">
&nbsp; <input value="添加分类" onclick="this.form.action='download-type!input.action?entity.parent.id=${entity.id}';this.form.onsubmit=null;" type="submit">
</div>
</form>
</div>
<div id="footer">
	...
	<s:if test="page.hasPre">
		<a href="download-type.action?page.pageNo=${page.prePage}&page.orderBy=${page.orderBy}&page.order=${page.order}&id=${entity.id}">上一页</a>
	</s:if>
	<s:if test="page.hasNext">
		<a href="download-type.action?page.pageNo=${page.nextPage}&page.orderBy=${page.orderBy}&page.order=${page.order}&id=${entity.id}">下一页</a>
	</s:if>
</div>
</body>
</html>