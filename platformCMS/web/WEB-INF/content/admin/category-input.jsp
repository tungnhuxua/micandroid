...
<div class="body-box">
<div class="rhead">
	<div class="rpos">当前位置： 文章系统 - 栏目管理 - 新增/修改</div>
	<div class="clear"></div>
</div>
<form id="tableForm" method="post" action="category!save">
<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1"
	...
	<tr>
		...
		<td colspan="3" width="88%" class="pn-fcontent">${entity.parent.name }</td>
	</tr>
	<tr>
		<td width="12%" class="pn-flabel pn-flabel-h"><span
			class="pn-frequired"></span>中文栏目名：</td>
		<td colspan="3" width="88%" class="pn-fcontent">
			<input class="required" name="entity.name" value="${entity.name}" type="text">
		</td>
	</tr>
	<tr>
		<td width="12%" class="pn-flabel pn-flabel-h"><span
			class="pn-frequired"></span>英文栏目名：</td>
		<td colspan="3" width="88%" class="pn-fcontent">
			<input class="required" name="entity.nameEn" value="${entity.nameEn}" type="text">
		</td>
	</tr>
	<tr>
