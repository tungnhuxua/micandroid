Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'*参数名称', width:139, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
		})}, field:{name:'task_param__param_name',type:'string'}},
	{col:{header:'*参数值', width:126, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
		})}, field:{name:'task_param__param_value',type:'string'}},
	{col:{header:'参数描述', width:179, sortable:true, editable:true, hcss:'color:#3039b4;',
		editor:new Ext.form.TextField({
			maxLength:100
