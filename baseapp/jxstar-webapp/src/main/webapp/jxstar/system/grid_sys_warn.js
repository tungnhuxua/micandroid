Jxstar.currentPage = function() {
	...
	{col:{header:'保留日志条数', width:100, sortable:true, hidden:true, renderer:JxUtil.formatInt()}, field:{name:'warn_base__log_num',type:'int'}},
	{col:{header:'上次运行时间', width:138, sortable:true, renderer:function(value) {
	...
	{col:{header:'上报ID', width:100, sortable:true, hidden:true}, field:{name:'warn_base__warn_id',type:'string'}},
	{col:{header:'邮件模板ID', width:100, sortable:true, hidden:true}, field:{name:'warn_base__templet_id',type:'string'}}
	];
