Jxstar.currentPage = function() {
	...
	{col:{header:'*索引名称', width:172, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
		})}, field:{name:'dm_indexcfg__index_name',type:'string'}},
	{col:{header:'*相关字段', width:219, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
	...
	{col:{header:'索引说明', width:271, sortable:true, editable:true, hcss:'color:#3039b4;',
		editor:new Ext.form.TextField({
			maxLength:200
