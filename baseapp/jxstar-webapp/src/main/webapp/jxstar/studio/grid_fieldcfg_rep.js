Jxstar.currentPage = function() {
	...
	{col:{header:'*序号', width:46, sortable:true, defaultval:'10', align:'right',
	...
	{col:{header:'*字段名称', width:100, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
		})}, field:{name:'dm_fieldcfg__field_name',type:'string'}},
	{col:{header:'*字段标题', width:100, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
