	...
	var items = [{
		...
		items: [{
			...
			items:[{
				...
				layout:'form',
				items:[
					{xtype:'numberfield', allowDecimals:false, fieldLabel:'序号', name:'dm_fieldcfg__field_index', defaultval:'10', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', anchor:'60%', maxLength:12},
				...
				items:[
					{xtype:'combo', fieldLabel:'状态', name:'dm_fieldcfg__state', defaultval:'1',
						anchor:'68%', readOnly:true, editable:false,
						store: new Ext.data.SimpleStore({
							fields:['value','text'],
							data: tablestateData
						}),
