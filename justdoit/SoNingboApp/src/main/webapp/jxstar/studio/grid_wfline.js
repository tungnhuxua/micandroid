Jxstar.currentPage = function() {
	...
	{col:{header:'主键', width:100, sortable:true, hidden:true}, field:{name:'wf_line__wfline_id',type:'string'}},
	{col:{header:'过程ID', width:100, sortable:true, hidden:true}, field:{name:'wf_line__process_id',type:'string'}}
	];
