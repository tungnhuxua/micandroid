		...
		items: [{
			...
			items:[{
				...
				items:[
					...
					{xtype:'trigger', fieldLabel:'功能名称', name:'warn_base__fun_name',
						...
						onTriggerClick: function() {
							var selcfg = {pageType:'combogrid', nodeId:'sel_fun', layoutPage:'/public/layout/layout_tree.js', sourceField:'fun_base.fun_name;fun_id', targetField:'warn_base.fun_name;fun_id', whereSql:"reg_type in ('main', 'treemain')", whereValue:'', whereType:'', isSame:'0', isShowData:'1', isMoreSelect:'0',isReadonly:'1',fieldName:'warn_base.fun_name'};
							Jxstar.createSelectWin(selcfg, this, 'node_sys_warn_form');
						}},
				...
				items:[
					...
					{xtype:'numberfield', allowDecimals:false, fieldLabel:'保留日志条数', name:'warn_base__log_num', anchor:'100%', maxLength:12},
