					...
					if(data1.sucflag){
						...
						if(data1.gatbeanlist!=null){
							$.each(data1.gatbeanlist,function(i,item){
								...
								gathtml+="<div>" +
										"<label>"+item.goodsattributename+"</label>"+
						...
						$.post("findGoodsParameter.action",{"goodsTypeId":data.bean.goodsTypeId},function(data2){
							if(data2.sucflag){
								...
								var jsonstr1=$.parseJSON("["+data.bean.goodsParameterValue+"]");
...
//        	 $.post('findProductSpecificationsTByspecificationsid.action',{"specificationsid":this.id},function(data){
...
//        				 strvalue="<select id='pst' name='pst'>" +
//        					 		"<option value='"+htmlJson.id+","+htmlJson.attributelist+","+htmlJson.sort+"'>"+htmlJson.goodsattributename+"</option>" +
//        					 		"</select>"
//        			 }
//        		 }else{
//        			 var myspecarray=new Array()
