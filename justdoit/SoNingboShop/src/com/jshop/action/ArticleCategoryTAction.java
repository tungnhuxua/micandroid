...
public class ArticleCategoryTAction extends ActionSupport {
	...
	public String findArticlCategoryByGradeZeroone() {
		...
		List<ArticleCategoryT> list = this.getArticleCategoryTServiceImpl().findArticleCategoryByGrade("0", "1", BaseTools.adminCreateId());
		if (!list.isEmpty()) {
	...
	public String findArticleCategoryByGradeTwo() {
		...
		List<ArticleCategoryT> list = this.getArticleCategoryTServiceImpl().findArticleCategoryByGrade("1", "1", BaseTools.adminCreateId());
		if (!list.isEmpty()) {
	...
	public String addArticleCategoryT() {
		int i = this.getArticleCategoryTServiceImpl().checkArticleCategoryName(this.getName(), BaseTools.adminCreateId());
		int j = this.getArticleCategoryTServiceImpl().checkArticleCategorySign(this.getSign(), BaseTools.adminCreateId());
		if (i == 0 && j == 0) {
			if (Integer.parseInt(this.getGrade()) == 0) {
				...
				this.getArticleCategoryTServiceImpl().addArticleCategoryT(act);
				this.setSucflag(true);
				return "json";
			} else {
	...
	public String findArticleCategoryByarticleCategoryTid() {
		if (Validate.StrNotNull(this.getArticleCategoryTid())) {
			bean = this.getArticleCategoryTServiceImpl().findArticleCategoryByarticleCategoryTid(this.getArticleCategoryTid());
			if (bean != null) {
				return "json";
			}
		}
	...
	public void findDefaultAllArticleCategory() {
		...
		int lineSize = rp;
		this.setStatus("1");
		total = this.getArticleCategoryTServiceImpl().countfindAllArticleCategoryT(this.getStatus(), BaseTools.adminCreateId());
		if (Validate.StrNotNull(sortname) && Validate.StrNotNull(sortorder)) {
			...
			List<ArticleCategoryT> list = this.getArticleCategoryTServiceImpl().sortAllArticleCategoryT(currentPage, lineSize, this.getStatus(), BaseTools.adminCreateId(), queryString);
			if (!list.isEmpty()) {
	...
	public String updateArticleCategoryT() {
		int i = this.getArticleCategoryTServiceImpl().checkArticleCategoryNamewithoutMe(this.getArticleCategoryTid(), this.getName(), BaseTools.adminCreateId());
		int j = this.getArticleCategoryTServiceImpl().checkArticleCategorySignwithoutMe(this.getArticleCategoryTid(), this.getSign(), BaseTools.adminCreateId());
		if (i == 0 && j == 0) {
			bean=this.getArticleCategoryTServiceImpl().findArticleCategoryByarticleCategoryTid(this.getArticleCategoryTid());
			...
			this.getArticleCategoryTServiceImpl().updateArticleCategoryT(bean);
			this.setSucflag(true);
			return "json";
		} else {
			this.setSucflag(false);
	...
	public String delArticleCategoryT() {
		if (Validate.StrNotNull(this.getArticleCategoryTid())) {
			...
			for (String s : strs) {  
				bean=this.getArticleCategoryTServiceImpl().findArticleCategoryByarticleCategoryTid(s);
			    bean.setArticleCategoryTid(s);
			    bean.setStatus("0");
			    bean.setCreatorid(BaseTools.adminCreateId());
			    this.getArticleCategoryTServiceImpl().delArticleCategoryT(bean);
			}  
			this.setSucflag(true);
			return "json";
		}
