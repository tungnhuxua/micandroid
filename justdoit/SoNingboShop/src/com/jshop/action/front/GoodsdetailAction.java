...
public class GoodsdetailAction extends ActionSupport {
	...
	public void UpdateGoodsReadCount(String goodsid){
		...
		int i=this.getGoodsTServiceImpl().updateGoodsreadcount(goodsid);
	}
	...
	public String GetGoodsCommentById(){
		int currentPage=1;
		int lineSize=10;
		beanlist=this.getGoodsCommentTServiceImpl().findGoodsCommentByGoodsid(this.getGoodsid().trim(), currentPage, lineSize);
		if(beanlist!=null){
