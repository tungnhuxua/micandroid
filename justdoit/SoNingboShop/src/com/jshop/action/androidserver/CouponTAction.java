...
public class CouponTAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
	@Resource(name="couponTServiceImpl")
	private CouponTServiceImpl couponTServiceImpl;
	...
	public CouponTServiceImpl getCouponTServiceImpl() {
		return couponTServiceImpl;
	}

	public void setCouponTServiceImpl(CouponTServiceImpl couponTServiceImpl) {
		this.couponTServiceImpl = couponTServiceImpl;
	}
	...
	public String findAllCoupon() throws IOException {
		...
		int lineSize = 10;
		beanlist = this.getCouponTServiceImpl().findAllCoupon(currentPage, lineSize);
		if (beanlist != null) {
