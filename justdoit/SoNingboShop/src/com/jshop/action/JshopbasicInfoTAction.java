...
public class JshopbasicInfoTAction extends ActionSupport {
	...
	public String addJshopbasicInfoT() {
		...
		if (this.getJshopbasicInfoTServiceImpl().addJshopbasicInfoT(jbi) > 0) {
	...
	public String findAllJshopbasicInfo() {
		...
		int lineSize = rp;
		List<JshopbasicInfoT> list = this.getJshopbasicInfoTServiceImpl().findAllJshopbasicInfo(currentPage, lineSize, BaseTools.adminCreateId());
		if (list != null) {
			total = this.getJshopbasicInfoTServiceImpl().countfindAllJshopbasicInfo(BaseTools.adminCreateId());
			rows.clear();
	...
	public String UpdateJshopbasicInfo() {
		...
		int i = this.getJshopbasicInfoTServiceImpl().updateJshopbasicInfo(jbi);
		this.setSucflag(true);
		return "json";
	...
	public String findJshopbasicInfoTById() {
		if (Validate.StrNotNull(this.getBasicinfoid())) {
			beanlist = this.getJshopbasicInfoTServiceImpl().findJshopbasicInfoTById(this.getBasicinfoid().trim());
			if (beanlist != null) {
				return "json";
			}
		}
	...
	public String delJshopbasicInfo() {
		...
		if (this.getBasicinfoid() != null) {
			...
			if (this.getJshopbasicInfoTServiceImpl().delJshopbasicInfo(array, BaseTools.adminCreateId()) > 0) {
				return "json";
			}
		}
		return "json";
	...
	public String updateJshopbasicInfostate() {
		if (this.getBasicinfoid() != null) {
			@SuppressWarnings("unused")
			int i = this.getJshopbasicInfoTServiceImpl().updateJshopbasicInfostate(this.getBasicinfoid(), this.getOpenstate());
			return "json";
		}
		return "json";
	}
