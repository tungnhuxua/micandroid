...
public class Serial {
	...
	@Resource(name="serialTServiceImpl")
	private SerialTServiceImpl serialTServiceImpl;
	
	
	public SerialTServiceImpl getSerialTServiceImpl() {
		return serialTServiceImpl;
	}

	public void setSerialTServiceImpl(SerialTServiceImpl serialTServiceImpl) {
		this.serialTServiceImpl = serialTServiceImpl;
	}

	public String Serialid(String serial){
		String serialid = null;
		SerialT list =this.getSerialTServiceImpl().findBybaseid(serial);
