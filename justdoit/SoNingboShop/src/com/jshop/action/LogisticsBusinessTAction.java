...
public class LogisticsBusinessTAction extends ActionSupport {
	...
	public String addLogisticsBusiness() {
		...
		if (this.getLogisticsBusinessTServiceImpl().addLogisticsBusiness(lb) > 0) {
			return SUCCESS;
		}
		return INPUT;
	...
	public String findAllLogisticsBusiness() {
		...
		int lineSize = rp;
		List<LogisticsBusinessT> list = this.getLogisticsBusinessTServiceImpl().findAllLogisticsBusiness(currentPage, lineSize);
		if (list != null) {
			total = this.getLogisticsBusinessTServiceImpl().countfindAllLogisticsBusiness();
			rows.clear();
	...
	public String UpdateLogisticsBusiness() {
		...
		lb.setCity(this.getCity());
		lb.setWebsite(this.getWebsite());
		this.getLogisticsBusinessTServiceImpl().updateLogisticsBusiness(lb);
		return "json";
	}
	...
	public String findLogisticsBusinessById() {
		if (Validate.StrNotNull(this.getLogisticsid())) {
			beanlist = this.getLogisticsBusinessTServiceImpl().findLogisticsBusinessById(this.getLogisticsid().trim());
			if (beanlist != null) {
				return "json";
			}
		}
	...
	public String DelLogisticsBusiness() {
		if (Validate.StrNotNull(this.getLogisticsid())) {
			...
			if (this.getLogisticsBusinessTServiceImpl().delLogisticsBusiness(strs) > 0) {
				return "json";
			}
			return "json";
		}
	...
	public String findAllLogisticsBusinessTjson() {
		...
		this.logisticsbusiness = this.getLogisticsBusinessTServiceImpl().findAllLogisticsBusinessTjson();
