...
public class ProductSpecificationsTAction extends ActionSupport {
	...
	@Resource(name = "productSpecificationsTServiceImpl")
	private ProductSpecificationsTServiceImpl productSpecificationsTServiceImpl;
	...
	@JSON(serialize = false)
	public ProductSpecificationsTServiceImpl getProductSpecificationsTServiceImpl() {
		return productSpecificationsTServiceImpl;
	}

	public void setProductSpecificationsTServiceImpl(ProductSpecificationsTServiceImpl productSpecificationsTServiceImpl) {
		this.productSpecificationsTServiceImpl = productSpecificationsTServiceImpl;
	}
	...
	public String addProductSpecification() {
		...
		pst.setState("1");
		this.getProductSpecificationsTServiceImpl().addProductSpecification(pst);
	...
	public void findDefaultAllProductSpecificationsT() {
		...
		int lineSize = rp;
		total = this.getProductSpecificationsTServiceImpl().countfindAllProductSpecificationsT();
		...
		if (Validate.StrNotNull(sortname) && Validate.StrNotNull(sortorder)) {
			List<ProductSpecificationsT> list = this.getProductSpecificationsTServiceImpl().sortAllProductSpecificationsT(currentPage, lineSize, queryString);
			if (list != null) {
	...
	public String findProductSpecificationsTByspecificationsid() {
		...
		if (Validate.StrNotNull(this.getSpecificationsid())) {
			bean = this.getProductSpecificationsTServiceImpl().findProductSpecificationsTByspecificationsid(this.getSpecificationsid().trim());
			if (bean != null) {
	...
	public String updateProductSpecification() {
		...
		int i = this.getProductSpecificationsTServiceImpl().updateProductSpecification(pst);
		this.setSucflag(true);
		return "json";
	...
	public String delProductSpecification() {
		...
		if (Validate.StrNotNull(this.getSpecificationsid())) {
			...
			int i = this.getProductSpecificationsTServiceImpl().delProductSpecification(list);
			this.setSucflag(true);
			return "json";
		} else {
	...
	public String findAllSpecificationsforjson() {
		...
		String strbeg = "";
		String strend = "";
		this.specification = this.getProductSpecificationsTServiceImpl().findAllProductSpecificationsTWithoutPage();
