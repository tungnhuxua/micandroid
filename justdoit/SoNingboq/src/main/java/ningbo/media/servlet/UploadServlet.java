...
public class UploadServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 2794649499177527603L;
	private File fileUploadPath;

	@Override
	public void init(ServletConfig config) {
		String abPath = config.getServletContext().getRealPath("");
		String initPath = config.getInitParameter("upload_path");
		StringBuffer buffer = new StringBuffer();
		buffer.append(abPath).append(initPath);
