...
import ningbo.media.common.util.Num62;
...
public class UploadUtil {
	 ...
	 * non-existent appearance with <code>basename(n).ext</code>. Where n is
	...
	public static void main(String args[]){
		System.out.println(generateFilename("/web/app/image","jpg")) ;
		System.out.println(isSingleExtension("test.jsp")) ;
		System.out.println(forceSingleExtension("test.jsp.jpg")) ;
	}
}
