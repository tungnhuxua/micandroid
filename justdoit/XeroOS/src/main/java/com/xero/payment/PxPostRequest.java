...
public class PxPostRequest {
	...
	/** the values list:0,1,2,&9 */
	private String Cvc2Presence = "";

	private String DateExpiry = "";

	/** If EnableAddBillCard set 1,then BillingId generate by payment express. */
	...
	/** Required.Supplied by Dps */
	private String PostUsername = "";

	/** Required.Supplied by Dps */
	private String PostPassword = "";

	/** Required ,then the values list:Auth,Complete,Refund,Validate */
	...
	/**
	 * Address Verification.Values are 1(Enable Verification),0(Disable
	 * Verification)
	 */
	...
	private void buildXml() {
		try {
			...
			text = doc.createTextNode(this.Amount);
			child.appendChild(text);

			child = doc.createElement("CardHolderName");
			root.appendChild(child);
			text = doc.createTextNode(this.CardHolderName);
			child.appendChild(text);

			child = doc.createElement("CardNumber");
			root.appendChild(child);
			text = doc.createTextNode(this.CardNumber);
			child.appendChild(text);
			...
			child = doc.createElement("Cvc2");
			root.appendChild(child);
			text = doc.createTextNode(this.Cvc2);
			child.appendChild(text);

			child = doc.createElement("Cvc2Presence");
			root.appendChild(child);
			text = doc.createTextNode(this.Cvc2Presence);
			child.appendChild(text);

			child = doc.createElement("DateExpiry");
			root.appendChild(child);
			text = doc.createTextNode(this.DateExpiry);
			child.appendChild(text);
			...
			child = doc.createElement("DpsBillingId");
			root.appendChild(child);
			text = doc.createTextNode(this.DpsBillingId);
			child.appendChild(text);

			child = doc.createElement("DpsTxnRef");
			root.appendChild(child);
			text = doc.createTextNode(this.DpsTxnRef);
			child.appendChild(text);
			...
			child = doc.createElement("InputCurrency");
			root.appendChild(child);
			text = doc.createTextNode(this.InputCurrency);
			child.appendChild(text);

			child = doc.createElement("MechantReference");
			root.appendChild(child);
			text = doc.createTextNode(this.MerchantReference);
			child.appendChild(text);

			child = doc.createElement("PostUsername");
			root.appendChild(child);
			text = doc.createTextNode(this.PostUsername);
			child.appendChild(text);

			child = doc.createElement("PostPassword");
			root.appendChild(child);
			text = doc.createTextNode(this.PostPassword);
			child.appendChild(text);
			...
			child = doc.createElement("EnableAvsData");
			root.appendChild(child);
			text = doc.createTextNode(this.EnableAvsData);
			child.appendChild(text);
			
			child = doc.createElement("AvsAction");
			root.appendChild(child);
			text = doc.createTextNode(this.AvsAction);
			child.appendChild(text);
			
			child = doc.createElement("AvsPostCode");
			root.appendChild(child);
			text = doc.createTextNode(this.AvsPostCode);
			child.appendChild(text);
			
			child = doc.createElement("AvsStreetAddress");
			root.appendChild(child);
			text = doc.createTextNode(this.AvsStreetAddress);
			child.appendChild(text);
			
			child = doc.createElement("DateStart");
			root.appendChild(child);
			text = doc.createTextNode(this.DateStart);
			child.appendChild(text);
			
			child = doc.createElement("IssueNumber");
			root.appendChild(child);
			text = doc.createTextNode(this.IssueNumber);
			child.appendChild(text);
			
			child = doc.createElement("Track2");
			root.appendChild(child);
			text = doc.createTextNode(this.Track2);
			child.appendChild(text);
