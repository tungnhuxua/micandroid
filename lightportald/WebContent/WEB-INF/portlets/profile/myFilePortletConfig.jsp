...
<input type='submit' name='action' onClick="document.pressed='apply';document.resetLastAction='1';" value='<fmt:message key="portlet.button.apply"/>' class='portlet-form-button' title='<fmt:message key="portlet.label.applyDefaultPrivacy.file"/>'/>
</td>
</tr>
</table>
</form>
