...
<td class='portlet-table-td-left'>
<input type='password' name='password' value='' class='portlet-form-input-field' size='20' onkeypress="return Light.keyDownLogin(event,'<c:out value="${requestScope.responseId}"/>');"/> 
</td>
<td>
</td>
</tr>
...
<input name='login' type='button' value='<fmt:message key="portlet.button.login"/>' class='portlet-form-button'
  onclick="javascript:Light.loginPortal('<c:out value="${requestScope.responseId}"/>');" />
</td>
</tr>
<tr>
<td class='portlet-table-td-left'></td>
