...
<html>
	<head>			    
	    <light:portalChannel channel="<%= org.light.portal.util.Constants._CHANNEL_FORUM %>"/>
	    ...
	    <meta name="keywords" content='<c:out value="${sessionScope.topic.topic}"/>'>
		<meta name="description" content='<c:out value="${sessionScope.topic.topic}"/>'>		
	    ...
	    <title><c:out value="${sessionScope.topic.topic}"/></title>
	</head>
	<body>		 
		<div id="initView">				
			<!-- google_ad_section_start -->
