 ...
 * @author Jianmin Liu
 **/
public class PortalMobileTag extends PortalBaseTag {
	private static Logger logger = LoggerFactory.getLogger(PortalMobileTag.class);
	...
	public int doStartTag() throws JspException {		
		...
		request.setAttribute(_MOBILE,1);
	    try{
	    	...
	    	String portalJSON = JSONUtil.getPortalData(request,this.getPortal(request),user.getDisplayName(),user,user.getId(),user,isAdmin(request),true).toString();
