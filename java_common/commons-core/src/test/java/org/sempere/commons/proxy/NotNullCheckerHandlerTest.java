...
/**
 * Unit tests class for NotNullCheckerHandler.
 *
 * @author bsempere
 */
public class NotNullCheckerHandlerTest {

    private NotNullStringCheckerHandler handler;

    @Before
    public void before() throws Exception {
        this.handler = new NotNullStringCheckerHandler("MyString");
    }
    ...
    private class NotNullStringCheckerHandler extends NotNullCheckerHandler<String> {

        public NotNullStringCheckerHandler(String object) {
            super(object);
        }
