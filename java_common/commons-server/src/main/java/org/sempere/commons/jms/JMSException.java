...
/**
 * Base exception class for exceptions encountered while using the JMSManager.
 *
 * @author bsempere
 */
public class JMSException extends SystemException {
    ...
    public JMSException(String message, Throwable th) {
        super(message, th, JMS);
    }
}