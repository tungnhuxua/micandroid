...
public class BaseAccessoriesAtegory extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this)
			...
			.append("SortNotes",getSortNotes())
			.append("ParentId",getParentId())
			.append("LowerNode",getLowerNode())
			.append("SortFormat",getSortFormat())
			.toString();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder()
			...
			.append(getSortName(),other.getSortName())
			.append(getSortNotes(),other.getSortNotes())
			.append(getParentId(),other.getParentId())
			.append(getLowerNode(),other.getLowerNode())
			.append(getSortFormat(),other.getSortFormat())
			.isEquals();
	}
