...
public class CmsTagCategoryAction extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	{ 
		...
		try
		{
			...
			/*** tagName 参数名无法提交数据，所以 修改名称。 Felix   */
			//cmsTagCategory.setCids(cids)
	...
	public void repetitionText() throws IOException {
		...
		textvalue = (null==this.getRequest().getParameter("textvalue")) ? "" : this.getRequest().getParameter("textvalue"); //权限元素
		Map<String, Object> result = new HashMap<String, Object>();
