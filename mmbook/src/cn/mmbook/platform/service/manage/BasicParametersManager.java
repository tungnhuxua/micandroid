...
/**
 * <p> BasicParameters server 接口<br> 
 * <p>   <br>
 * @author admin,
...
public interface BasicParametersManager {
	/**按ID 查询对象*/
	BasicParameters getById(java.lang.Integer id);
	/**查询所有数据*/
	List findAll();
	/**查询数据返回LIST*/
	List getList(BasicParameters u);
	/**保存数据 由BaseManager类实现*/
	void save(BasicParameters u);
	/**修改数据由BaseManager类实现*/
	void update(BasicParameters u);
	/**删除数据由BaseManager类实现*/
	...
	/**验证查询*/
	List verification(BasicParameters u);
