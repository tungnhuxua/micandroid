...
public interface TagModelManager {
	/**按ID 查询对象*/
	TagModel getById(java.lang.String id);
	/**查询所有数据*/
	List findAll();
	/**查询数据返回LIST*/
	List getList(TagModel u);
	/**保存数据 由BaseManager类实现*/
	void save(TagModel u);
	/**修改数据由BaseManager类实现*/
	void update(TagModel u);
	/**删除数据由BaseManager类实现*/
