...
/**
 * <p> BaseAccessories server 接口<br> 
 * <p>   <br>
 * @author admin,
...
public interface BaseAccessoriesManager {
	/**按ID 查询对象*/
	BaseAccessories getById(java.lang.String id);
	/**查询所有数据*/
	List findAll();
	/**查询数据返回LIST*/
	List getList(BaseAccessories u);
	/**保存数据 由BaseManager类实现*/
	void save(BaseAccessories u);
	/**修改数据由BaseManager类实现*/
	void update(BaseAccessories u);
	/**删除数据由BaseManager类实现*/
