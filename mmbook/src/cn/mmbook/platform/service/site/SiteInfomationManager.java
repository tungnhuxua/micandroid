...
public interface SiteInfomationManager {
	/**按ID 查询对象*/
	SiteInfomation getById(java.lang.Integer id);
	/**查询所有数据*/
	List findAll();
	/**查询数据返回LIST*/
	List getList(SiteInfomation u);
	/**保存数据 由BaseManager类实现*/
	void save(SiteInfomation u);
	/**修改数据由BaseManager类实现*/
	void update(SiteInfomation u);
	/**删除数据由BaseManager类实现*/
