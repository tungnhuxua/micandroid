        ...
        <div class="block">
          <div class="block-bot">
            ...
            <div class="row-articles articles">
              <div class="cl">&nbsp;</div>
            <c:forEach items="${fenYe.list}" var="video">
              <div class="article">
                <div class="cl">&nbsp;</div>
                ...
                <div class="cl">&nbsp;</div>
            		 ...
            		 <form action="/team1_videoplay_v2.0/videoListServlet.do?videoTypeID=${videoTypeID}&page=1" id="dd" >
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  <tr>
			
			    <td align="right">当前页数：[${fenYe.page}/${fenYe.pagecount}]&nbsp;
				<a href="/team1_videoplay_v2.0/videoListServlet.do?videoTypeID=${videoTypeID}&page=1">第一页</a>　<a href="/team1_videoplay_v2.0/videoListServlet.do?videoTypeID=${videoTypeID}&page=${fenYe.page>1 ? fenYe.page-1 : 1}">上一页</a>
				
				<a href="/team1_videoplay_v2.0/videoListServlet.do?videoTypeID=${videoTypeID}&page=${fenYe.page<fenYe.pagecount?fenYe.page+1:fenYe.pagecount}">下一页</a>　<a href="/team1_videoplay_v2.0/videoListServlet.do?videoTypeID=${videoTypeID}&page=${fenYe.pagecount}">最后一页&nbsp;</a>
