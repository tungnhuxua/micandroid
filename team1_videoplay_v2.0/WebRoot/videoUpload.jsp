...
<script src="js/checkMoney.js" type="text/javascript"></script>
<script src="js/videoTypeOption.js" type="text/javascript"></script>
</head>
<body>
<!-- Page -->
      ...
      <div id="content">
        ...
        <div class="block">
          <div class="block-bot">
           ...
           <form action="videoUploadServlet.do" method="post" enctype="multipart/form-data">    
            <div class="row-articles articles">
              ...
              <div class="article">
                ...
                <div class="cnt">
                  	标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：<input type="text" value="" name="title" style="background-color: gray;border-width: 0px;"/><br/><br/>
                  	关&nbsp;键&nbsp;字：<input type="text" value="" name="keyWords" style="background-color: gray;border-width: 0px;"/><br/><br/>
                  	类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：
                  	<select name="videoTypeID" id="videoType" style="background-color: gray;border-width: 0px;">
                  		<option value="请选择">请选择</option>
                  	</select><br><br>
                  	是否收费：
                  	<input type="radio" name="requirdMoney" id="requirdMoney1" value="1"/>收费&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  	<input type="radio" name="requirdMoney" id="requirdMoney2" checked="checked" value="0"/>不收费<br/><br/>
                    <div class="cnt" id="showAddMoney" style="display: none;">
                    	填入收费金额：<input type="text" name="requirdMoneyCount" style="background-color: gray;border-width: 0px;"/>
                    </div>
                     <br> <br> 
                上传图片：<input type="file" name="pictureURL" size="14" style="background-color: gray;border-width: 0px;"/> <br/>
        
               	<br/><br/>
           上传视频：<input type="file" name="videoURL" size="14" style="background-color: gray;border-width: 0px;"/> <br/>
          
                	<br/><br/>
                  	描&nbsp;&nbsp;&nbsp;&nbsp;述：<textarea name="videoDetail" rows="6" cols="20"style="background-color: gray;border-width: 0px;"></textarea><br/><br/>
                	<input type="submit" value="上传" style="width: 105px; height: 29px; background: url(css/images/sign-button.gif) no-repeat 0 0;border-width: 0px;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               		 <input type="button" value="返回" onclick="javascript:history.go(-1);" style="width: 105px; height: 29px; background: url(css/images/sign-button.gif) no-repeat 0 0;border-width: 0px;"/>
                </div>
                <div align="center">
                </div>
                <div class="cl">&nbsp;</div>
