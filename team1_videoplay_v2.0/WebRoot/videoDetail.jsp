							...
							<div class="block-bot">
								...
								<div class="row-articles articles">
									...
									<div class="article">
										...
										<div class="image">
											<img src="${videoInfo.video_pictureUrl}" />
										</div>
										<div class="cnt">
											标题: ${videoInfo.video_title}
											<br />
											<br />
											视频积分： ${videoInfo.video_point}
											<br>
											<br />
											播放次数： ${videoInfo.video_playcount}
											<br>
											<br />
											上传时间： ${videoInfo.video_uploadtime}
											<br>
											<br />
											视频大小： ${videoInfo.video_size}KB
											<br>
											<br />
											播放收费： ${videoInfo.video_requirdMoney}
											<br />
											<br />
											视频详细：
											...
											<br>
											<br />
											<c:if test="${videoInfo.video_requirdMoney==0}">
												<div id="sign" class="block" style="width: 100px">
													<div class="block-bot">
														<div class="block-cnt">
															<div class="cl">
																&nbsp;
															...
															<a class="button button-left"
																href="videoPlayServlet.do?videoID=${videoInfo.video_id}&videoPlayRequirdMoney=0">播&nbsp;放
															</a>
															<div class="cl">
																&nbsp;
															</div>
											...
											<c:if test="${videoInfo.video_requirdMoney>0}">
												...
												<c:choose>
														...
														<div id="sign" class="block" style="width: 100px">
															<div class="block-bot">
																<div class="block-cnt">
																	...
																	<a class="button button-left"
																		onclick="javascript:alert('请先登录')" style=""><font
																		size="4">播&nbsp;放</font> </a>
																	<div class="cl">
																		&nbsp;
																	</div>
													...
													<c:when
														test="${user.user_money<videoInfo.video_requirdMoney}">
														<font color="red">您的余额：${user.user_money}</font>
														<br />
														...
														<div id="sign" class="block" style="width: 100px">
															<div class="block-bot">
																...
																<div class="block-cnt">
																	...
																	<a class="button button-left" id="clickButton">播&nbsp;放
																	</a>
																	<div class="cl">
																		&nbsp;
																	</div>
														...
														<div id="sign" class="block" style="width: 100px">
															<div class="block-bot">
																<div class="block-cnt">
																	...
																	<a class="button button-left"
																		href="videoPlayServlet.do?videoID=${videoInfo.video_id}&videoPlayRequirdMoney=${videoInfo.video_requirdMoney}">播&nbsp;放
																	</a>
																	<div class="cl">
																		&nbsp;
																	</div>
          ...
          <div class="block-bot">
            ...
            <ul>
            	<li>东华理工大学授权，team one项目组完成，感谢东华理工大学，感谢厦门万策的吴老师的指导</li>
						...
						<p class="copy">
							&copy; Design by
							<a href="myteam.jsp">Ecit team one</a>
						</p>
					</div>
					<!-- / Footer -->
				</div>
