...
<title>gameportal by www.865171.cn</title>
        ...
        <div class="block">
          <div class="block-bot">
            ...
            <div class="row-articles articles">
              <div class="cl">&nbsp;</div>
           <form action="videoUpdateServlet.do?videoID=${video.video_id}" method="post"> 
              <div class="article">
                <div class="cl">&nbsp;</div>
                <div class="image">
                <img src="css/images/img9.jpg" alt=""/><br/><br><br><br/><br><br/>&nbsp; 
                <br/>&nbsp; 
                <br/><br/>&nbsp; 
                <br/><br/>
                <br>
                ...
                <div class="cnt">
                  	标&nbsp;&nbsp;&nbsp;&nbsp;题：<input type="text" name="title" value="${video.video_title}" style="background-color: gray;border-width: 0px;"/><br/><br/>
                  	播放次数：${video.video_playcount}<br/><br/>
                  	上传时间：${video.video_uploadtime}<br/><br/>
                  	视频大小：${video.video_size}KB<br/><br/>
                  	描&nbsp;&nbsp;&nbsp;&nbsp;述：<textarea name="desc" rows="6" cols="20"style="background-color: gray;border-width: 0px;">${video.video_desc}</textarea><br/><br/>
                	<input type="submit" value="修改" style="width: 105px; height: 29px; background: url(css/images/sign-button.gif) no-repeat 0 0;border-width: 0px;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
