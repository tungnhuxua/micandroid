          ...
          <div class="block-bot">
            ...
            <div class="row-articles articles">
              ...
              <div class="article">
              	...
              	<!-- 这里放视频播放 -->
              	<OBJECT  id='pmlxflash' classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000'
					 width=630    height=500    align=middle    hspace=0    vspace=0>
					 <param name='wmode'  value='transparent'>
					 <param name='allowFullScreen' value='true' />
					 <param name= 'Movie' value='${videourl}'>
					 </OBJECT>
					 <a href="fullscreen.jsp?fileName=${videourl}">全屏观看</a>
              	</div>
              </div>
              <div class="cl">&nbsp;</div>
            </div>
        ...
        <div class="block">
          <div class="block-bot">
            ...
            <div class="row-articles articles">
              <div class="cl">&nbsp;</div>
             <!-- 循环评论 -->
             <c:if test="${empty reviews}"><div align="center"><font>暂无评论</font></div></c:if>
             <c:if test="${!empty reviews}">
	             <c:forEach items="${reviews}" var="review" varStatus="status">
	              <div class="article">
	              	${status.index+1}楼<br/>
	              	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${userList[status.index].user_name}说：${review.review_content}<br/>
	              </div>                                     
	             </c:forEach>
             </c:if>
              <!-- 循环评论结束 --><br/><br/><br/>
              <c:if test="${!empty sessionScope.userInfo}">
               <form action="doScoreServlet.do?videoID=${videoID}" method="post">
              	<div>评&nbsp;论&nbsp;内&nbsp;容：<textarea name="content" cols="40"></textarea></div><br/>
              	<div>打&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分&nbsp;:&nbsp;
              			<input type="radio" name="reviewScore" value="1">1分
		              	<input type="radio" name="reviewScore" value="2">2分
		              	<input type="radio" name="reviewScore" value="3">3分
		              	<input type="radio" name="reviewScore" value="4">4分
		              	<input type="radio" name="reviewScore" value="5">5分</div><br/>
