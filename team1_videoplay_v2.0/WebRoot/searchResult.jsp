        ...
        <div class="block">
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<a href="/team1_videoplay_v2.0/searchServlet.do?page=1">第一页</a>　<a href="/team1_videoplay_v2.0/searchServlet.do?page=${fenYe.page>1 ? fenYe.page-1 : 1}">上一页</a>
				
				<a href="/team1_videoplay_v2.0/searchServlet.do?page=${fenYe.page<fenYe.pagecount?fenYe.page+1:fenYe.pagecount}">下一页</a>　<a href="/team1_videoplay_v2.0/searchServlet.do?page=${fenYe.pagecount}">最后一页&nbsp;</a>
