        ...
        <div class="block">
          <div class="block-bot">
            ...
            <form action="userModifyServlet.do" method="post">
              <div class="article">
                <div class="cnt"> 
                  	姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：<input type="text" value="${sessionScope.userInfo.user_name}" name="username" readonly="readonly" style="background-color: gray;border-width: 0px;"/><br/><br/>
                  	密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="text" value="${sessionScope.userInfo.user_password}" name="password" style="background-color: gray;border-width: 0px;"/><br/><br/>
                  	银行账号：<input type="text" value="${sessionScope.userInfo.user_account}" name="account" style="background-color: gray;border-width: 0px;"/><br/><br/>
                  	邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input type="text" value="${sessionScope.userInfo.user_email}" name="email" style="background-color: gray;border-width: 0px;"/><br/><br/>
                  	手机号码：<input type="text" value="${sessionScope.userInfo.user_telephone}" name="telephone" style="background-color: gray;border-width: 0px;"/><br/><br/>
                  	密码找回问题:<select name="question" style="background-color: gray;border-width: 0px;">
                  	<c:choose>
                  	<c:when test="${sessionScope.userInfo.question=='您的母亲名字'}">
                  			<option value="您的母亲名字" selected="selected">您的母亲名字</option>
							<option value="您的父亲名字">您的父亲名字</option>
							<option value="您的中学名字">您的中学名字</option>
                  	</c:when>
                  	<c:when test="${sessionScope.userInfo.question=='您的父亲名字'}">
                  			<option value="您的母亲名字">您的母亲名字</option>
							<option value="您的父亲名字" selected="selected">您的父亲名字</option>
							<option value="您的中学名字">您的中学名字</option>
                  	</c:when>
                  	<c:otherwise>
                  			<option value="您的母亲名字">您的母亲名字</option>
							<option value="您的父亲名字">您的父亲名字</option>
							<option value="您的中学名字" selected="selected">您的中学名字</option>
                  	</c:otherwise>
                  			
                  	</c:choose>
							
						</select><br/><br/>
						您的答案：<input type="text" name="answer" value="${sessionScope.userInfo.answer}" style="background-color: gray;border-width: 0px;"/>
						<br/><br/>
                	<input type="submit" value="确定修改" style="width: 105px; height: 29px; background: url(css/images/sign-button.gif) no-repeat 0 0;border-width: 0px;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                		<input type="reset" value="重新填写" style="width: 105px; height: 29px; background: url(css/images/sign-button.gif) no-repeat 0 0;border-width: 0px;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               		 <input type="button" value="返回到上一页" onclick="javascript:history.go(-1);" style="width: 105px; height: 29px; background: url(css/images/sign-button.gif) no-repeat 0 0;border-width: 0px;"/>
                </div>
                <div align="center">
                </div>
                <div class="cl">&nbsp;</div>
