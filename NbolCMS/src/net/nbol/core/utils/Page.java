...
public class Page<T> {
	...
	/**
	 * 功能：取得分页参数的组合字符串. 将多个分页参数组合成一个字符串方便在页面上的传递,格式为pageNo|orderBy|order.
	 * @return String
	 */
	...
	/**
	 * 功能：设置分页参数的组合字符串. 将多个分页参数组合成一个字符串方便在页面上的传递,格式为pageNo|orderBy|order.
	 * @param pageRequest
	 */
