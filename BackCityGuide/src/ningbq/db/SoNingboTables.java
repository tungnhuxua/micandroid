...
public abstract class SoNingboTables {
	...
	public static class UserTable {
		...
		public static String getCreateSQL() {
			String createString = TABLE_NAME + "( " 
					...
					+ Columns.USER_ID + " TEXT UNIQUE NOT NULL, " 
					+ Columns.USER_NAME + " TEXT UNIQUE NOT NULL, " 
					...
					+ Columns.STATUSES_COUNT + " INT, " 
					+ Columns.CREATED_AT + " INT, " 
					+ Columns.FOLLOWING + " INT DEFAULT 0, "
					+ Columns.NOTIFICATIONS + " INT DEFAULT 0, "
					+ Columns.UTC_OFFSET + " TEXT, "
					+ Columns.LOAD_TIME + " TIMESTAMP default (DATETIME('now', 'localtime')) "
					+ ");";
	...
	public static class FirstCategoryTable{
		...
		public static String getCreateSQL(){
			String createString = TABLE_NAME + "( " 
					+ Columns.ID + " INTEGER PRIMARY KEY, "
					+ Columns.FRIST_ID + " TEXT UNIQUE NOT NULL, "
					+ Columns.NAME_CN + " TEXT, "
		...
		public static String[] getIndexColumns() {
			return new String[]{Columns.ID,Columns.FRIST_ID,Columns.NAME_CN,Columns.NAME_EN} ;
		}
	}
	...
	public static class SecondCategoryTable{
		...
		public static String getCreateSQL(){
			String createString = TABLE_NAME + "( " 
					+ Columns.ID + " INTEGER PRIMARY KEY, "
					+ Columns.SECOND_ID + " TEXT UNIQUE NOT NULL, "
					+ Columns.FIRST_ID + " TEXT, "
					+ Columns.NAME_CN + " TEXT, "
					+ Columns.NAME_EN + " TEXT "
					+ ");";
		...
		public static String[] getIndexColumns() {
			return new String[]{Columns.ID,Columns.SECOND_ID,Columns.FIRST_ID,Columns.NAME_CN,Columns.NAME_EN} ;
		}
	...
	public static class LocationTable{
		...
		public static String getCreateSQL(){
			String createString = TABLE_NAME + "( " 
					+ Columns.ID + " INTEGER PRIMARY KEY, "
					+ Columns.LOCATION_ID + " TEXT UNIQUE NOT NULL, "
					+ Columns.SECOND_ID + " TEXT, "
					+ Columns.NAME_CN + " TEXT, "
					+ Columns.NAME_EN + " TEXT, "
					+ Columns.ADDRESS_CN + " TEXT, "
					+ Columns.ADDRESS_EN + " TEXT, "
					+ Columns.TELEPHONE + " TEXT, "
		...
		public static String[] getIndexColumns(){
			return new String[]{Columns.ID,Columns.LOCATION_ID,
					...
					Columns.ADDRESS_CN,Columns.ADDRESS_EN,
					Columns.TELEPHONE,Columns.LONGITUDE,Columns.LATITUDE} ;
		}
	}
