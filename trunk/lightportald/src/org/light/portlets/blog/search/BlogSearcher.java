 ...
 * @author Jianmin Liu
 **/
public class BlogSearcher extends GenericSearcher implements org.light.portal.search.Searcher{	
	private Logger logger = LoggerFactory.getLogger(this.getClass()); 
	
	public SearchResult search(Class entityType, SearchCriteria criteria) throws Exception{
		if(!Blog.class.equals(entityType)) return null;
	...
	public SearchResult search(SearchCriteria criteria) throws Exception { 
		...
		try {
			...
			Query query1 = new QueryParser(Version.LUCENE_30,Indexer._TYPE_ID,analyzer).parse(BlogIndexer._TYPE);			
