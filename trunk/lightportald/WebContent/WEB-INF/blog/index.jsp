...
<html>
	<head>			    
	    <light:portalChannel channel="<%= org.light.portal.util.Constants._CHANNEL_BLOG %>"/>
	    ...
	    <meta name="keywords" content='<c:out value="${sessionScope.blog.title}"/>'>
		<meta name="description" content='<c:out value="${sessionScope.blog.summary}"/>'>		
	    ...
	    <title><c:out value="${sessionScope.blog.title}"/></title>
	</head>
	<body>		 
		<div id="initView">				
			<!-- google_ad_section_start -->
