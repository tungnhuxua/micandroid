...
/**
 * Base exception class for exceptions encountered while using NamingManager.
...
public class NamingException extends SystemException {
    ...
    private static final long serialVersionUID = 9171717396228553901L;
    ...
    public NamingException(String message, Throwable th) {
        super(message, th, NAMING);
    }
}