...
padding:25px">
<div style="font-size:18px;  color:#666">加入您的图片，完成您的个人资料</div>
<div style="font-size:12px;  color:#999">寻找您的电子邮件帐户，以最快的方式找到他们</div>

<div style="float:right; width:220px"><input type="file" name="file" id="image_upload" /><div style="margin-top:40px; width:100px" class="btn" id="webcam_image_btn">Use Webcam</div><div style="margin-top:40px; width:100px" class="btn" id="webcam_image_btn">Save Picture</div></div>
...
<div style="float:left; margin-top:100px" class="btn" id="step3_back_btn">回去 </div>
<div style="float:right; margin-top:100px" class="btn" id="step3_next_btn">下一页 </div>
