...
<div style="font-size:12px;  color:#999">这些信息将帮助你找到朋友, 完成尽可能多或尽可能少你喜欢</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="40%" style="text-align:right; font-size:14px; padding-right:15px; color:#666">你住的地方的建设名称: </td>
  ...
  <tr>
    <td style="text-align:right; font-size:14px; padding-right:15px; color:#666">婚姻状况划分的: </td>
    <td><select name="reg_marital" id="reg_marital" class="drop_down">
        ...
        <option value="4">在关系</option>
        <option value="3">单和快乐</option>
        <option value="2">单和寻找爱情</option>
      </select></td>
  </tr>
</table>
</div>

<div style="float:left; margin-top:40px" class="btn" id="step2_back_btn">回去 </div>
<div style="float:right; margin-top:40px" class="btn" id="step2_next_btn">下一页 </div>
