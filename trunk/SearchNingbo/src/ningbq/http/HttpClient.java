...
public class HttpClient {
	...
	private static final int SOCKET_TIMEOUT_MS = 2 * 1000;
	...
	public Response httpRequest(String url,
		...
		/*
		 * if (TwitterApplication.DEBUG) { DebugTimer.betweenStart("HTTP"); }
		 */
		...
		/*
		 * if (TwitterApplication.DEBUG) { DebugTimer.betweenEnd("HTTP"); }
		 */
		return res;
	}
	...
	public Response getForParams(String url, Map<String, String> params) {
