...
/**
 * <p> ContentContentReal server 接口<br> 
 * <p>   <br>
 * @author admin,
...
public interface ContentContentRealManager {
	/**按ID 查询对象*/
	ContentContentReal getById(java.lang.Integer id);
	/**查询所有数据*/
	List findAll();
	/**查询数据返回LIST*/
	List getList(ContentContentReal u);
	/**保存数据 由BaseManager类实现*/
	void save(ContentContentReal u);
	/**修改数据由BaseManager类实现*/
	void update(ContentContentReal u);
	/**删除数据由BaseManager类实现*/
