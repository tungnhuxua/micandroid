...
/**
 * <p> PartSubjectReal server 接口<br> 
 * <p>   <br>
 * @author admin,
...
public interface PartSubjectRealManager {
	/**按ID 查询对象*/
	PartSubjectReal getById(java.lang.Integer id);
	/**查询所有数据*/
	List findAll();
	/**查询数据返回LIST*/
	List getList(PartSubjectReal u);
	/**保存数据 由BaseManager类实现*/
	void save(PartSubjectReal u);
	/**修改数据由BaseManager类实现*/
	void update(PartSubjectReal u);
	/**删除数据由BaseManager类实现*/
