...
public class CmsTagContent extends BaseEntity {
	...
	private java.lang.String continueModeNo;//小说连载状态
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder()
			...
			.append(getPosId(),other.getPosId())
			.append(getKeyId(),other.getKeyId())
