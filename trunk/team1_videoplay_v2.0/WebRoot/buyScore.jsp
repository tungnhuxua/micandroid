        ...
        <div class="block">
          <div class="block-bot">
            ...
            <div class="row-articles articles">
              ...
              <div class="article">
              <form action="buyScoreServlet.do" method="post" onSubmit="return checkBuyScore()">  
                	我的钱包余额: ￥${sessionScope.userInfo.user_money} 
                	<br/><br/>
                	我的积分: ${sessionScope.userInfo.user_point}M
                	<br/>
                	<br/>  
                	购买积分数 :&nbsp;&nbsp; <input type="text" name="buyStore" id="buyStore" onblur="checkBuyStore(${sessionScope.userInfo.user_money})"/>
                	<span id="checkMoney"></span>
                	<br/>
                	<br/>
                	<font color="red">说明：一元人民币可换一个积分，多多购买，好礼相送...</font><br/>
                	<br/>
