        ...
        <div class="block">
          <div class="block-bot">
            ...
            <div class="row-articles articles">
              ...
              <div class="article">
              <form action="applyMoneyServlet.do" method="post" onSubmit="return checkPayUserResult()"> 
                	我的钱包: ￥${user.user_money}
                	<br/>
                	<br/> 
                	提现金额:<input type="text" name="getMoney" id="getMoney" onblur="checkWallet(${sessionScope.userInfo.user_money})"/><span id="checkWalletResult"></span>               	<br/>
                	<br/>
                	<input type="submit" value="&nbsp;确定提现&nbsp;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                	<a href="buyScore.jsp">去购买积分？</a>
                </form>
              </div>
              <div class="cl">&nbsp;</div>
            </div>
