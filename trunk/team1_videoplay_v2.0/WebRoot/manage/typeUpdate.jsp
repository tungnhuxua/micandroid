  ...
  <div id="main">
    <div id="main-bot">
      ...
      <div id="myContent">
          ...
          <div style="width: 60%;">
          <form action="/video/updateTypeServlet.do?typeID=${videoType.type_id}" method="post">
          <table class="styleTable">
          	<tr><td>类别名称</td><td><input type="text" name="type_name" value="${videoType.type_name}"/></td></tr>
          	<tr><td>类别描述</td><td><textarea name="type_desc">${videoType.type_desc}</textarea></td></tr>
