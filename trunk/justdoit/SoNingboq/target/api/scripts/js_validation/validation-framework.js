...
// instead.
var ValidationRoot = "js_validation/";
...
ValidationFramework.validateDepend = function(field, depend) {
	if (depend.getName() == "required") {
		...
		ValidationFramework.exception("��δʵ�ָ������� " + depend.getName());
		return false;
	}
}
...
ValidationFramework.getDocumentElement = function() {
	...
	if (xmlDoc.documentElement == null) {
		ValidationFramework.exception("�����ļ���ȡ�������顣");
		return null;
	}
...
ValidationFramework.getErrorString = function(field, depend) {
	...
	if (dep == "minlength" || dep == "maxlength" || dep == "date" ) {
		...
		if (eqField == null) {
			ValidationFramework.exception("�Ҳ������Ϊ[" + depend.getParams()[0]+"]��������xml�����ļ���");
			retStr = "<<���ô���>>";
		} else {
...
ValidationFramework.getWebFormFieldObj = function(field) {
	...
	if (obj == null) {
		ValidationFramework.exception("�������ļ�������Ҫ��֤���򣬵���ʵ����ҳ�?�в����ڣ�[name=" + field.getName() + "]��");
	}
	return obj;
}

ValidationFramework.exception = function(str) {
	var ex = "JavaScript Validation Framework ����ʱ����:\n\n";
	ex += str;
	ex += "\n\n\n�κ����д��󶼻ᵼ�¸�����֤ʧ�ܡ�";
	alert(ex);
}
ValidationFramework.getIntegerValue = function(val) {
	...
	if (isNaN(intvalue)) {
		ValidationFramework.exception("�ڴ�һ�����Ͳ���");
	}
	return intvalue;
}
...
ValidationErrorString["zh-cn"]["default"]="��{0}У��ʧ�ܡ�";
ValidationErrorString["zh-cn"]["required"]="{0}����Ϊ�ա�";
ValidationErrorString["zh-cn"]["integer"]="{0}������һ������";
ValidationErrorString["zh-cn"]["double"]="{0}������һ���������С��㣩��";
ValidationErrorString["zh-cn"]["commonchar"] = "{0}��������ͨӢ���ַ���ĸ�����ֺ��»��ߡ�";
ValidationErrorString["zh-cn"]["chinesechar"] = "{0}�����������ַ�";
ValidationErrorString["zh-cn"]["minlength"]="{0}���Ȳ���С��{1}���ַ�";
ValidationErrorString["zh-cn"]["maxlength"]="{0}���Ȳ��ܴ���{1}���ַ�" ;
ValidationErrorString["zh-cn"]["invalid"]="{0}��Ч��";                                                             
ValidationErrorString["zh-cn"]["date"]="{0}����һ����Ч���ڣ��ڴ��ʽ��{1}��";
ValidationErrorString["zh-cn"]["integerrange"]="{0}����������{1}��{2}֮�䡣";
ValidationErrorString["zh-cn"]["doublerange"]="{0}�����ڸ�����{1}��{2}֮�䡣";
ValidationErrorString["zh-cn"]["pid"]="{0}����һ����Ч���֤�š�";
ValidationErrorString["zh-cn"]["email"]="{0}����һ����Ч��Email��";
ValidationErrorString["zh-cn"]["equalsfield"]="{0}�����{1}һ�¡�";
