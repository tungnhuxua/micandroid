					...
					height=20></TD>
							...
							<TR>
							  ...
							  <TD align=middle colSpan=5 style="margin:5px 0;line-height:48px;font-size:12pt;color:red;border-bottom:1px solid #eee">
								<P style="background:url(resources/images/layout/404/warning-large.png) no-repeat 20px 0"><strong>很抱歉，您要访问的页面不存在。
								</strong></P></TD>
							...
							<TR>
							  <TD align=left colSpan=5 height=80>
								...
								<UL>
								  ...
								  <LI id=list2>打开<a href="home.html">系统主页</a>，然后查找指向您感兴趣信息的链接。</LI>
