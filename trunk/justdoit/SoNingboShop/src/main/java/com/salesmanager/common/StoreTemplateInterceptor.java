...
public class StoreTemplateInterceptor extends HandlerInterceptorAdapter {
	
	   private Logger log = Logger.getLogger(StoreTemplateInterceptor.class);
	   ...
	   public boolean preHandle(
			...
			request.setAttribute("merchantId", mStore.getMerchantId());
