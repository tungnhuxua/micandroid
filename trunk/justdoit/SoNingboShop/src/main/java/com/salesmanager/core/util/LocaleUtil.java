...
public class LocaleUtil {
	...
	public static void setLocaleForRequest(HttpServletRequest request,
			HttpServletResponse response, MerchantStore store)
			throws Exception {
		...
		Locale persistantLocale = (Locale) session.getAttribute("WW_TRANS_I18N_LOCALE");
		
		if(persistantLocale==null) {
			locale = null;
		}
		...
		String req_locale = (String) request.getParameter("locale");
