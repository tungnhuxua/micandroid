...
public class OrderInvoiceTAction extends ActionSupport {
	@Resource(name="orderInvoiceTServiceImpl")
	private OrderInvoiceTServiceImpl orderInvoiceTServiceImpl;
	...
	public OrderInvoiceTServiceImpl getOrderInvoiceTServiceImpl() {
		return orderInvoiceTServiceImpl;
	}

	public void setOrderInvoiceTServiceImpl(OrderInvoiceTServiceImpl orderInvoiceTServiceImpl) {
		this.orderInvoiceTServiceImpl = orderInvoiceTServiceImpl;
	}
	...
	public void finddefaultAllOrderInvoice() {
		...
		int lineSize = rp;
		total = this.getOrderInvoiceTServiceImpl().countfindAllOrderIvoice();
		List<OrderInvoiceT> list = this.getOrderInvoiceTServiceImpl().findAllOrderIvoice(currentPage, lineSize);
		if (list != null) {
	...
	public String DelOrderInvoice() {
		if (Validate.StrNotNull(this.getOrderInvoiceid())) {
			...
			int i = this.getOrderInvoiceTServiceImpl().delOrderInvoice(strs);
			return "json";
		}
		return "json";
	}
	...
	public String UpdateOrderInvoiceState() {
		if (Validate.StrNotNull(this.getOrderInvoiceid())) {
			String[] strs = this.getOrderInvoiceid().trim().split(",");
			int i = this.getOrderInvoiceTServiceImpl().updateOrderInvoiceState(strs, this.getState());
			return "json";
		}
		return "json";
	}
