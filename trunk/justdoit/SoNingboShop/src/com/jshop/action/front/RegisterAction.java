...
public class RegisterAction extends ActionSupport {
	...
	@Action(value = "register", results = { 
			...
			@Result(name = "register_error",type="redirect",location = "/html/default/shop/register.html?msg=${msg}"),
			@Result(name = "useractivates",type="redirect",location = "/html/default/shop/register.html?msg=${msg}")
	})
	...
	public String updateUserstate(){
		if(Validate.StrNotNull(this.getUid())){
			UserT user=new UserT();
			user=this.getUsertServiceImpl().finduserByuid(this.getUid());
			if(user!=null){
				if(user.getUserstate().equals("0")){
					user.setUserstate("1");
