	...
	<div id="left">
		<div id="menu">
			...
			<!-- <h6 id="h-menu-saletools">
				<a href="#saletools"><span>淘宝工具管理</span>
				</a>
			</h6>
			<ul id="menu-saletools" class="closed">
				<li>
					<a id="link1" href="<%=basePatha%>jshop/admin/taobao/tbonsaleItemsmanagement.jsp?session=6584359BA964336B9BDE75737952F5AA#saletools">淘宝上架商品列表</a>
				</li>
				<li class="last">
					<a id="link2" href="<%=basePatha%>jshop/admin/taobao/tbtraderdatamanagement.jsp?session=6584359BA964336B9BDE75737952F5AA#saletools">180评论报表</a>
				</li>
			</ul> -->
