Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'项目名称', width:199, sortable:true}, field:{name:'ph_project__project_name',type:'string'}},
	{col:{header:'项目编号', width:100, sortable:true}, field:{name:'ph_project__project_code',type:'string'}},
	...
	{col:{header:'项目经理', width:100, sortable:true}, field:{name:'ph_project__pm_user',type:'string'}},
	{col:{header:'技术方案简述', width:100, sortable:true, hidden:true}, field:{name:'ph_project__tech_desc',type:'string'}},
