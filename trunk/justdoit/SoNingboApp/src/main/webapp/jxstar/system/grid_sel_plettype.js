Jxstar.currentPage = function() {
	...
	{col:{header:'栏目ID', width:100, sortable:true, hidden:true}, field:{name:'v_plet_type__type_id',type:'string'}},
	{col:{header:'内容ID', width:100, sortable:true, hidden:true}, field:{name:'v_plet_type__object_id',type:'string'}},
