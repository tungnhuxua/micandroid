Jxstar.currentPage = function() {
	...
	{col:{header:'表ID', width:100, sortable:true, hidden:true}, field:{name:'dm_table__table_id',type:'string'}},
	{col:{header:'状态', width:100, sortable:true, hidden:true}, field:{name:'dm_table__state',type:'string'}},
	...
	{col:{header:'表空间', width:100, sortable:true, hidden:true}, field:{name:'dm_table__table_space',type:'string'}},
	{col:{header:'表说明', width:100, sortable:true, hidden:true}, field:{name:'dm_table__table_memo',type:'string'}},
	{col:{header:'表主键', width:100, sortable:true, hidden:true}, field:{name:'dm_table__key_field',type:'string'}}
	];
