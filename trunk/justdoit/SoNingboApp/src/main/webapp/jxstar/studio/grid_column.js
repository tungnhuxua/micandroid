Jxstar.currentPage = function() {
	...
	{col:{header:'控件名称', width:100, sortable:true, editable:true, hcss:'color:#3039b4;',
		editor:new Ext.form.TriggerField({
			...
			onTriggerClick: function() {
				if (this.menu == null) {
					var selcfg = {pageType:'combogrid', nodeId:'sel_combo', layoutPage:'', sourceField:'v_combo_control.control_code', targetField:'fun_col.control_name', whereSql:"", whereValue:'', whereType:'', isSame:'1', isShowData:'1', isMoreSelect:'0',isReadonly:'1',fieldName:'fun_col.control_name'};
					this.menu = Jxstar.createComboMenu(this);
					Jxstar.createComboGrid(selcfg, this.menu, 'node_sys_fun_col_editgrid');
				}
	...
	{col:{header:'统计列?', width:100, sortable:true, hidden:true, defaultval:'0'}, field:{name:'fun_col__is_statcol',type:'string'}},
