Jxstar.currentPage = function() {
	...
	{col:{header:'*表名称', width:124, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
		})}, field:{name:'dm_tablecfg__table_name',type:'string'}},
	{col:{header:'*表标题', width:141, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
	...
	{col:{header:'*表主键', width:105, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
	...
	{col:{header:'表说明', width:391, sortable:true, editable:true, hcss:'color:#3039b4;',
		editor:new Ext.form.TextField({
			maxLength:200
