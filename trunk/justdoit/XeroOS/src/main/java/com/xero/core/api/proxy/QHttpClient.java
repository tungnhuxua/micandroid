...
public class QHttpClient {
    ...
    // 日志输出
    private static Logger log = LoggerFactory.getLogger(QHttpClient.class) ;
     ...
     */
    public QHttpClient(int maxConnectionsPerHost, int maxTotalConnections, int conTimeOutMs, int soTimeOutMs, HttpHost proxy) {
