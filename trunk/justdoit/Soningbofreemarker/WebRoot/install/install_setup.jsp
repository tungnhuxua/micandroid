<%@page contentType="text/html; charset=utf-8" language="java" import="com.jeecms.cms.Install,java.util.*" pageEncoding="utf-8" %>
...
<%
	...
	String dbFileName = "/install/db/jeecms-db-3.0.2-final.sql";
	String initFileName = "/install/db/jeecms-init-3.0.2-final.sql";
