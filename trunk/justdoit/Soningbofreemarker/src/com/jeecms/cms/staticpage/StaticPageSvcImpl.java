...
public class StaticPageSvcImpl implements StaticPageSvc, InitializingBean {
	...
	public int content(Integer siteId, Integer channelId, Date start,
		...
		FrontUtils.frontData(request, data, site, null, null);
		return content(siteId, channelId, start, data);
	}
	...
	public void content(Content content) throws IOException, TemplateException {
		...
		if (request == null) {
			throw new IllegalStateException(
					"HttpServletRequest not found in CmsThreadVariable.");
		}
	...
	public int channel(Integer siteId, Integer channelId, boolean containChild,
		...
		data.put("base", request.getContextPath());
		FrontUtils.frontData(request, data, site, null, null);
		return channel(siteId, channelId, containChild, data);
	}
	...
	public void channel(Channel channel, boolean firstOnly) throws IOException,
		...
		channel(channel, firstOnly, request);
	}
	...
	public void index(HttpServletRequest request) throws IOException,
		...
		Map<String, Object> data = new HashMap<String, Object>();
		data.put("base", request.getContextPath());
		FrontUtils.frontData(request, data, site, null, site.getUrlStatic());
