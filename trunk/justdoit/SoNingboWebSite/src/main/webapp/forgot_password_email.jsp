...
padding:25px">
  <div style="font-size:18px;  color:#666">请检查您的电子邮件!</div>
<div style="font-size:12px;  color:#999">如果我们发现您的帐户，我们向您发送电子邮件</div>

<div style="font-size:12px;  color:#999; margin-top:15px;"></div>

<div style="float:left; margin-top:410px" class="btn" id="index_btn">返回 </div>
    </div>
