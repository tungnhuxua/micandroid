package ningbo.media.web.http;

import java.io.File;
import java.util.List;

import ningbo.media.web.bean.QParameter;
import ningbo.media.web.util.QHttpUtil;
...
public class SoNingboHttpClient {

	private static final int CONNECTION_TIMEOUT = 2000000;
	private static Log log = LogFactory.getLog(SoNingboHttpClient.class);
	/**
	 * Using GET method.
	 * 
	 * @param url
