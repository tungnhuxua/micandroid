...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<title>资讯_${showCategory.name}</title>
	...
	<div class="container">	
		...
		<div id="content">
			...
			<div id="postion">
				<p>
					<span>您的位置:首页&gt;<a href="${ctx }/news">资讯</a>&gt;${showCategory.name}</span>
				</p>
			</div>
			<div id="contentLeft">
				<div id="totop">
				...
				<div id="tabshow">
					...
					<div style="padding-left:96px">
						...
						<s:if test="page.hasPre">
							<a href="newslist.action?page.pageNo=${page.prePage}&page.orderBy=${page.orderBy}&page.order=${page.order}&showCategory.id=${showCategory.id}">上一页</a>
						</s:if>
						<ouun:pageNum totalPages="${page.totalPages}" pageNo="${page.pageNo}" url="newslist.action?page.orderBy=${page.orderBy}&page.order=${page.order}&showCategory.id=${showCategory.id}&page.pageNo=" />
						<s:if test="page.hasNext">
							<a href="newslist.action?page.pageNo=${page.nextPage}&page.orderBy=${page.orderBy}&page.order=${page.order}&showCategory.id=${showCategory.id}">下一页</a>
						</s:if>
					</div>
