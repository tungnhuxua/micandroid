...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="container">
		...
		<div id="content">
			...
			<div id="postion">
				<p>
					<span>您的位置:首页&gt;<a href="${ctx }/show?showCategory.id=56">秀场</a>&gt;搜索</span>
				</p>
			</div>
			<div id="contentLeft">
				<div id="totop">
				...
				<div id="tabshow">
					...
					<div style="padding-left:96px">
						...
						<s:if test="page.hasPre">
							<a href="showsearcharticle.action?page.pageNo=${page.prePage}&newsContent=${newsContent}">上一页</a>
						</s:if>
						<ouun:pageNum totalPages="${page.totalPages}" pageNo="${page.pageNo}" url="showsearcharticle.action?newsContent=${newsContent}&page.pageNo=" />
						<s:if test="page.hasNext">
							<a href="showsearcharticle.action?page.pageNo=${page.nextPage}&newsContent=${newsContent}">下一页</a>
						</s:if>
					</div>
