...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<title>首页-${article.category.name }-${article.title }</title>
	...
	<div id="top">
		...
		<div id="content">
			...
			<div id="postion">
				<p>
					<span>您的位置:首页&gt;${article.category.name }</span>
				</p>
			</div>
			...
			<div id="contentLeft">
				...
				<div id="voteinfo">
					<dl>
						...
						<dd><a href="${ctx}/searcharticlecontent.action?article.id=${preArticle.id}">上一篇_ ${preArticle.title }</a></dd>
						</s:if>
						<s:if test="nextArticle!=null">
						<dd><a href="${ctx}/searcharticlecontent.action?article.id=${nextArticle.id}">下一篇_ ${nextArticle.title}</a></dd>
						</s:if>
					</dl>
				</div>
				...
				<div id="listsugges">
					<ul>
						...
						<li>
						   <a href="${ctx}/searcharticle.actioncontent?article.id=${id}">
				...
				<div id="projectscontent">
					<dl id="proleft">
						...
						<s:iterator value="TagCorrelationArticle">
							<dd><span><a href="${ctx}/searcharticlecontent.action?article.id=${id}">${title}</a></span></dd>
						</s:iterator>
					</dl>
				...
				<div id="articlelist">
					...
					<div>
					<dl>
						<dt>${member.name } , <s:date name="createDate" format="yyyy年MM月dd日" />,<s:date name="createDate" format="HH.mm.ss" /></dt>
						<dd>${content}</dd>
					</dl>
					</div>
					</div>
