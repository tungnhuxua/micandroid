                 ...
                 <div id="listcenter">
                    ...
                    <div style="padding-left:10px;padding-top:40px;width:760px">
						...
						<s:if test="page.hasPre">
							<a href="circle-member.action?page.pageNo=${page.prePage}">上一页</a>
						</s:if>
						<ouun:pageNum totalPages="${page.totalPages}" pageNo="${page.pageNo}" url="circle-member.action?&page.pageNo=" />
						<s:if test="page.hasNext">
							<a href="circle-member.action?page.pageNo=${page.nextPage}">下一页</a>
						</s:if>
					</div>
